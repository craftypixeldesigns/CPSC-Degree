...
registerCreditButtonHandlers();
registerLectureButtonHandlers();
...
function createVis() {
	...
	// add circles based off credits, lecture, lab	
	node.append("circle")
	...
	// set variables for positioning nodes
	var focusHierarchyY = 
		[
			(height/5)*0.8,
			(height/5)*1.6,
	...
	// reposition nodes and attributes based on position
  	force.on("tick", function(e) {
  			_.each(cpscgraph.courses, function(d, i) {
  				...
  				// Group y values based off course levels
				...
				// Group x values based off last two digits of num
...
function setDefaultStyles() {
	...
	// add onclick handlers to ensure non-overlapping ranges
	...
	// set button colors state for credits, lectures, lab
...
// Toggle standard button appearance
...
// Determine how many Course Streams were selected
// to change node styles
...
// Update node styles when availability is pressed/still pressed
...
// TODO
// How to call function in d3.select and pass
// this & a value?
function DEPRECATED_NOT_WORKING(num) {
	console.log(num);
...
// Credits filter
// TODO inefficient - 
function registerCreditButtonHandlers() {
...
// Lecture filter
// TODO inefficient
function registerLectureButtonHandlers() {
